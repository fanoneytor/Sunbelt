package com.microservicio.sunbelt.controlador;

import com.microservicio.sunbelt.entidad.Cliente;
import com.microservicio.sunbelt.servicio.ClienteServicio;
...
public class ClienteControlador {
    ...
    public ResponseEntity<?> consultarCliente(@RequestBody Cliente peticion){
        try{
            ...
            Cliente clienteConsultado = clienteServicio.consultarCliente(peticion.getTipo_documento(), peticion.getNumero_documento());
